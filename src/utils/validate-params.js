...
const validateCommand = (client, commandsOptions) => {
    ...
    if ("format" in commandsOptions && typeof commandsOptions.format !== "string")
        throw new TypeError("Command format must be a string.");
    if ("details" in commandsOptions && typeof commandsOptions.details !== "string")
        throw new TypeError("Command details must be a string.");
    if (commandsOptions.examples && (!Array.isArray(commandsOptions.examples) || commandsOptions.examples.some((example) => typeof example !== "string")))
